...
public class Crabby : MonoBehaviour
{
    ...
    {
        CheckForPlayer();
        groundAndWallCheckPosition = new Vector3(transform.position.x + moveDirection * groundAndWallCheckOriginOffset, transform.position.y, transform.position.z);
    }
    ...
    {
        var hit = Physics2D.Raycast(groundAndWallCheckPosition, Vector2.down, groundAndWallCheckOriginOffset, groundLayer);
    ...
    {
        var groundAndWallCheckPositionGizmos = new Vector3(transform.position.x + moveDirection * groundAndWallCheckOriginOffset, transform.position.y, transform.position.z);
